<?php return array (
  ...
  array (
    ...
    array (
      ...
      'index.html' => '网站首页',
      'list.html' => '列表页',
      'list_intro.html' => '企业简介列表页',
      'list_team.html' => '科研团队列表页',
    ...
    'templates|dejiemo|link' =>
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|dejiemo|special' =>
    array (
      'api_picture.html' => '组图',
    ...
    'templates|dejiemo|announce' =>
    array (
      'show.html' => '内容页',
    ),
    'templates|dejiemo|wap' =>
    array (
    ...
    'templates|dejiemo|phpsso' =>
    array (
      'index.html' => '首页',
    ),
    'templates|dejiemo|search' =>
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|dejiemo|formguide' =>
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|dejiemo|mood' =>
    array (
      'index.html' => '新闻心情',
    ),
    'templates|dejiemo|yp' =>
    array (
      'com_dejiemo' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|dejiemo|yp|com_default' =>
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|dejiemo|comment' =>
    array (
